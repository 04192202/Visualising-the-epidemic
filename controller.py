...
//定时器
setInterval(get_sys_time,3000)
setInterval(get_center1, 3000)
setInterval(get_center2, 3000)
setInterval(get_left1, 3000)
setInterval(get_left2, 3000)
setInterval(get_right1,3000)
setInterval(get_right2,5000)
